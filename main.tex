...
We can re-organize the above equations in the following form:
...
$K_{i}$ is just the resultant field gradient normalized by the magnetic rigidity.
...
\begin{equation}
\Delta \nu_{x} = -\frac{1}{4\pi}\beta_{x}K_{x}L
\end{equation}


\begin{equation}
\Delta \nu_{y} = -\frac{1}{4\pi}\beta_{y}K_{y}L
\end{equation}
