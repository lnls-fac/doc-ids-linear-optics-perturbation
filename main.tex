...
\begin{equation}
\Delta \nu_{x} = -\beta_{x} \frac{k_x^2}{k_z^2}\frac{L^2B_0^2}{16\pi R^2}\bigg(1+\cos(k_z\theta)-\frac{k_x^2}{k_z^2+k_x^2}\left(1-\cos(k_z\theta)\right)\bigg)
\end{equation}


\begin{equation}
\Delta \nu_{y} = \beta_{y} \frac{k_z^2+k_x^2}{k_z^2}\frac{L^2B_0^2}{8\pi R^2}
\end{equation}
